...
#define scanBorderW self.frame.size.width-30*2
#define scanBorderH self.frame.size.width-30*2
#define scanBorderX 30
#define scanBorderY 0.5 * (self.frame.size.height - scanBorderH)
/** 扫描内容的 x 值 */
...
- (UIView *)contentView {
    if (!_contentView) {
       ...
       // _contentView.frame = CGRectMake(scanBorderX, scanBorderY, scanBorderW, scanBorderW);
        _contentView.frame = CGRectMake(scanBorderX, scanBorderY, scanBorderW, scanBorderH);
...
- (void)drawRect:(CGRect)rect {
    ...
    CGFloat borderH =  scanBorderH ;//borderW;
  ...
  //  UIBezierPath *bezierPath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(borderX + 0.5 * borderLineW, borderY + 0.5 *borderLineW, borderW - borderLineW, borderH - borderLineW) cornerRadius:cornerLenght];
    [bezierPath fill];
    // 执行混合模式
...
//    [borderPath stroke];
   ...
   // CGFloat cornerLenght = 20;
    ...
    UIBezierPath *leftTopPath = [UIBezierPath bezierPath];
     // UIBezierPath *leftTopPath = [UIBezierPath bezierPathWithArcCenter:CGPointMake(borderX + cornerLenght, borderY + cornerLenght) radius:cornerLenght startAngle:-M_PI endAngle:-M_PI/2.0 clockwise:YES];
  ...
  //  UIBezierPath *leftBottomPath = [UIBezierPath bezierPathWithArcCenter:CGPointMake(borderX + cornerLenght, borderY + borderH - cornerLenght) radius:cornerLenght startAngle:M_PI/2 endAngle:M_PI clockwise:YES];
  ...
  //  UIBezierPath *rightTopPath = [UIBezierPath bezierPathWithArcCenter:CGPointMake(borderX + borderW - cornerLenght, borderY+cornerLenght) radius:cornerLenght startAngle:-M_PI/2.0 endAngle:0 clockwise:YES];
  ...
  //  UIBezierPath *rightBottomPath = [UIBezierPath bezierPathWithArcCenter:CGPointMake(borderX + borderW - cornerLenght, borderY + borderH - cornerLenght) radius:cornerLenght startAngle:0 endAngle:M_PI/2.0  clockwise:YES];
