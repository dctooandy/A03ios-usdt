 ...
 *
 */
@protocol KLDNetDiagnoServiceDelegate <NSObject>
/**
 * 告诉调用者诊断开始
 */
 ...
 */
@interface KLDNetDiagnoService : NSObject {
}
@property (nonatomic, weak, readwrite)
    id<KLDNetDiagnoServiceDelegate> delegate;      //向调用者输出诊断信息接口
