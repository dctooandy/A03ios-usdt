                                     ...
                                     CFDataRef address, const void *data, void *info)
{
    if (data != NULL) {
        printf("connect");
        KLDNetConnect *con = (__bridge_transfer KLDNetConnect *)info;
...
- (void)readStream:(BOOL)success
{
    ...
    if (success) {
        ...
        NSInteger interval = [KLDNetTimer computeDurationSince:_startTime] / 1000;
        _sumTime += interval;
