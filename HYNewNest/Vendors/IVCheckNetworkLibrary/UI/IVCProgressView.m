...
//  @See: https://github.com/Tbwas/IVCProgressView
...
#pragma mark - IVProgressLayer

@interface IVKProgressLayer : CALayer
...
@implementation IVKProgressLayer {
...
#pragma mark - IVCProgressView

@implementation IVCProgressView

+ (Class)layerClass {
    return [IVKProgressLayer class];
}
...
- (void)setProgress:(float)progress animated:(BOOL)animated {
    ...
    IVKProgressLayer *layer = (IVKProgressLayer *)self.layer;
    layer.progress = _progress;
    [(IVKProgressLayer *)self.layer setProgressWithAnimated:animated];
}
