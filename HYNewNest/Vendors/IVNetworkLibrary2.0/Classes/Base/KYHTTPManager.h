...
/**
 ...
 @param callBack 回调
 */
- (NSURLSessionTask *)sendRequestWithUrl:(NSString *)url callBack:(nullable KYHTTPCallBack)callBack;
...
/**
 ...
 @param callBack 回调
 */
- (NSURLSessionTask *)sendRequestWithUrl:(NSString *)url parameters:(id)parameters callBack:(nullable KYHTTPCallBack)callBack;
