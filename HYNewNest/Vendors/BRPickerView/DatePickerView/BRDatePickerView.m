...
/** 确定选择的回调 */
@property (nonatomic, copy) BRDateConfirmBlock confirmBlock;
/** 取消选择的回调 */
...
+ (void)showDatePickerWithTitle:(NSString *)title
    ...
    BRDatePickerView *datePickerView = [[BRDatePickerView alloc]initWithTitle:title dateType:dateType defaultSelValue:defaultSelValue minDate:minDate maxDate:maxDate isAutoSelect:isAutoSelect themeColor:themeColor resultBlock:resultBlock confirmBlock:nil cancelBlock:cancelBlock];
...
+ (void)showDatePickerWithTitle:(NSString *)title
                ...
                defaultSelValue:(NSString *)defaultSelValue
                   ...
                   isAutoSelect:(BOOL)isAutoSelect
                     themeColor:(UIColor *)themeColor
                    resultBlock:(BRDateResultBlock)resultBlock
                   confirmBlock:(BRDateConfirmBlock)confirmBlock
                    cancelBlock:(BRDateCancelBlock)cancelBlock{
     BRDatePickerView *datePickerView = [[BRDatePickerView alloc]initWithTitle:title dateType:dateType defaultSelValue:defaultSelValue minDate:minDate maxDate:maxDate isAutoSelect:isAutoSelect themeColor:themeColor resultBlock:resultBlock confirmBlock:confirmBlock cancelBlock:cancelBlock];
    [datePickerView showWithAnimation:YES];
...
- (UIDatePicker *)datePicker {
    if (!_datePicker) {
        ...
        _datePicker.backgroundColor = self.alertView.backgroundColor;
        // 设置子视图的大小随着父视图变化
