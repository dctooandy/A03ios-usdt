...
#import "BRImageStringPickerView.h"
...
@interface BRImageStringPickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
{
...
@implementation BRImageStringPickerView
...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    [self showStringPickerWithTitle:title dataSource:dataSource images:images defaultSelValue:defaultSelValue isAutoSelect:NO themeColor:nil resultBlock:resultBlock cancelBlock:nil];
}
...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    BRImageStringPickerView *strPickerView = [[BRImageStringPickerView alloc]initWithTitle:title dataSource:dataSource images:images defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect themeColor:themeColor resultBlock:resultBlock cancelBlock:cancelBlock];
...
- (UIPickerView *)pickerView {
    if (!_pickerView) {
        ...
        _pickerView.backgroundColor = self.alertView.backgroundColor;
        // 设置子视图的大小随着父视图变化
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view {
    ...
    if (!view) {
        CGFloat height = 35.0f * kScaleFit;
        view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.alertView.frame.size.width, height)];
        
        // 图片
        UIImageView *iv = [[UIImageView alloc] initWithFrame:CGRectMake(120, (height-26)*0.5, 26, 26)];
        [view addSubview:iv];
        iv.tag = 100;
        
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(160, 0, self.alertView.frame.size.width-140, height)];
