...
- (void)getYuEBaoYesterdaySumHandler:(void (^)(CNYuEBaoBalanceModel * _Nonnull model))handler;

/// 直接从接口获取数据 将倒计时重置为120s
- (void)requestBalaceHandler:(nullable AccountBalancesBlock)handler;
- (void)requestBetAmountHandler:(nullable void(^)(BetAmountModel * model))handler;
- (void)requestYuEBaoYesterdaySumHandler:(nullable void(^)(CNYuEBaoBalanceModel * model))handler;
