...
@interface HYNewUsrMissonAlertView()<UITextViewDelegate>

@end

@implementation HYNewUsrMissonAlertView
{
...
+ (void)showFirstDepositOrTaskEndIsEnd:(BOOL)isTaskEnd handler:(void(^)(BOOL isComfm))handler{
    ...
    HYNewUsrMissonAlertView *a = [[HYNewUsrMissonAlertView alloc] init];
