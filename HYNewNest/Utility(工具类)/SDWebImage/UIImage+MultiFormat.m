...
- (SDImageFormatTwo)sd_imageFormat {
    SDImageFormatTwo imageFormat = SDImageFormatUndefined2;
...
- (void)setSd_imageFormat:(SDImageFormatTwo)sd_imageFormat {
...
- (nullable NSData *)sd_imageData {
    return [self sd_imageDataAsFormat:SDImageFormatUndefined2];
}
