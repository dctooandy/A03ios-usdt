...
typedef void(^SDExternalCompletionBlock)(NSData * _Nullable data, UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL);
